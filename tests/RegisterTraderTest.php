...
class RegisterTraderTest extends TestCase
{
    ...
    /**
     * @expectedException \TechFinancials\Exceptions\EmailAlreadyExistsException
     */
    public function testRegistrationWithExistedEmail()
    {
        $apiResponse = new Response(200, [], $this->getStub('failedRegisterTrader-identicalAlreadyFound.json'));
        $this->mockResponse($apiResponse);
        $this->apiClient->registerTrader(new RegisterTraderRequest());
    }
}
